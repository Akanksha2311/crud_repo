...
const Contacts = () => {
  ...
  return (
        <>
            <div className="jumbotron jumbotron-fluid" style={{ background:'rgb(49, 159, 202)' }}>
                <div className="container" >
                    <h1 className="display-4 text-center" style={{ fontWeight:'bold' , color:'white' }}>Contact Registration</h1>
                </div>
            </div>
            <div className="row">
